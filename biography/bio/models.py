...
class Bio(models.Model):
    ...
    ar_degree      = models.CharField(max_length=32, default='', blank=True)
    ...
    ar_job_type    = models.CharField(max_length=256, default='', blank=True)
    ar_job_place   = models.CharField(max_length=256, default='', blank=True)
